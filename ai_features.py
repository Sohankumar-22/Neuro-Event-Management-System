...
VENUE_MOOD_MAP = {
    ...
    "kolkata": ["🏮 Cultural", "🏛️ Heritage", "🌸 Artistic", "✨ Classic"],
    "chennai": ["🌊 Coastal", "🏛️ Traditional", "🌿 Elegant", "🌟 Grand"],
    "pune": ["⛰️ Scenic", "💻 Tech-Modern", "☕ Sophisticated", "🌸 Vibrant"],
    "ahmedabad": ["🎨 Heritage", "🏢 Commercial", "✨ Traditional", "🌟 Lively"],
}
